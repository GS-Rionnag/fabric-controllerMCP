...
| Development anchor | Build and validate the first implementation against Minecraft Java 26.2, then add version-family adapters and compatibility testing for earlier Fabric-supported releases. Pin the exact Fabric Loader, mappings, optional Fabric API, and Java toolchain during scaffolding. | 2026-09-13 |
